		...
		public void DrawHeader(Rect rect)
		{
			...
			if (GUI.Button(rect, "Load Preset"))
			{
				...
				if (openPath != "")
				{
					...
					UnityEditor.Editor.DestroyImmediate(iconEditor.materialEditor);
					iconEditor.materialEditor = (MaterialEditor)UnityEditor.Editor.CreateEditor((UnityEngine.Object)iconEditor.reorderableList.list[iconEditor.reorderableList.index]);
				}
			}
		}
