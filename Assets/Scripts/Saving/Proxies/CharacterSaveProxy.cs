...
namespace Saving.Proxies
{
    ...
    public class CharacterSaveProxy : ASaveProxy
    {
        ...
        {
            SpeciesModel speciesModel = SpeciesModelVariableName.GetValue<CustomizationPlatform, SpeciesModel>(FindObjectOfType<CustomizationPlatform>());
            CharacterSaveData data = new CharacterSaveData
            {
                OutfitIndex = speciesModel.Outfits.IndexOf(OutfitVariableName.GetValue<CustomizationPlatform, string>(FindObjectOfType<CustomizationPlatform>())),
                ColorIndex = speciesModel.Colors.IndexOf(ColorVariableName.GetValue<CustomizationPlatform, Color>(FindObjectOfType<CustomizationPlatform>())),
